    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        when (call.method) {
            "getPrinter" -> {
                try {
                    val printerInfo =
                        printerSearchingService.getMostCompatiblePrinter(applicationContext).get()
                    result.success(printerInfo.toMap())
            ...
            "selectPrinter" -> {
                ...
                try {
                    printer =
                        printerSearchingService.getPrinterFromPortName(applicationContext, portName)
                            .get()
                } catch (e: NoSuchElementException) {
            ...
            "print" -> {
                val receiptInfo: ArrayList<HashMap<String, String>> =
                    call.argument<ArrayList<HashMap<String, String>>>("receiptInfo") as ArrayList<HashMap<String, String>>
